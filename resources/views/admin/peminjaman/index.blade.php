      ...
      <thead>
        ...
        <tr class="text-gray-700 dark:text-gray-400">
          <th class="px-4 py-3 text-sm">
            ...
            <td class="px-4 py-3">
                <div class="flex items-center space-x-4 text-sm">
                    <form action="{{ route('admin.pinjam.destroy', $borrowing->id) }}" method="post">
                        @csrf
                        @method('DELETE')
                        <button onclick="return confirm('Apakah anda yakin ingin mengembalikan buku yang dipilih?');"
                    ...
                    <a
                    href="{{ route('admin.pinjam.edit', $borrowing->id) }}"
            ...
            @empty
            <tr>
                <td colspan="7" style="color: red; text-align: center; padding: 15px;">Data Peminjaman Kosong!</td>
            </tr>
            </tbody>
            @endforelse
        </table>
